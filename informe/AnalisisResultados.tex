\section{Experimentos y análisis de resultados}
	...
	\paragraph{}Los resultados de las heurísticas han sido obtenidos en el siguiente equipo:
		...
		\begin{itemize}
			...
			\item CPU: AMD Ryzen 9 3900X (12) @ 3.800 GHz
	...
	\paragraph{}Como vimos en clase de teoría, la introducción de la actualización de la feromona localmente se introduce para favorecer la exploración de los arcos que no se hayan visitado, dado que la actualización de la feromona local tiene como consecuencia que esta disminuya siempre.
	...
	\paragraph{}En este punto tomamos la decisión de volver a ejecutar el algoritmo pero modificando el valor y asignando el valor 1/m*C(S) a $\tau_{0}$, donde m es el número de elementos de la solución y C(S) es el coste de la solución de la hormiga hasta el momento (tal y como viene indicado en las diapositivas de teoría).
	...
	\paragraph{}Como bien sabemos, la Lista Restringida de Candidatos almacena los x elementos del dominio del problema que aún no forman parte de la solución que mayor coste aportarían a esta.
	...
	\paragraph{}En los siguientes gráficos de cajas y bigotes se comparan las 5 ejecuciones de cada algoritmo para cada serie de datos, comentados brevemente.
	...
	\paragraph{}Para la serie de datos MDG-22, en cuanto a agrupamiento de datos, el el mejor algoritmo es el S.C.H., seguido de la búsqueda tabú, la búsqueda local y, en último lugar la búsqueda local.
