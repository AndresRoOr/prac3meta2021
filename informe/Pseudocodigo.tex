	...
	\paragraph{}El funcionamiento de esta función es trivial: se inicializan todas las hormigas con un elemento generado aleatoriamente con la función "GenerarEnteroAleatorio()". Cuando tengamos "tamañoColonia" (parámetro del programa) hormigas inicializadas, devolvemos la colonia como resultado.